...
<script setup>
/*
  Vous n'avez pas besoin d'importer directement les images
  ici puisque nous utilisons des chemins absolus (`/images/`)
  qui pointent directement vers le dossier `images` à la racine.
*/
</script>
